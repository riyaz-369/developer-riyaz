...
const Card = ({ project }) => {
  ...
  return (
    <Link
      ...
      className="card bg-dark shadow-lg rounded-3xl border transition-all duration-300 hover:shadow-primary/50 border-primary border-opacity-30 hover:border-primary"
    >
      <figure>
    ...
    //     <div className="w-full mb-8 shadow-xl">
    //       <Image
    //         src={image}
    //         alt={title}
    //         objectFit="cover"
